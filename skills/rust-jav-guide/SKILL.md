---
name: rust-jav-guide
description: 讲解如何使用 rust-jav 通过 `tui`、`ops` 和 `actor-links` 整理 JAV 媒体目录。适用于用户询问 rust-jav 怎么运行、某个命令做什么、该用哪些参数、preview / `--apply` / `--json` 的区别、如何生成示例 fixtures，或想要一套安全的 rust-jav 常见使用流程时。
---
